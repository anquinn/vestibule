...
export default class extends Controller {
  ...
  _backgroundHTML() {
    return `<div id="${this.backgroundId}" class="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-75 dark:bg-dark-gray-900 dark:bg-opacity-75 transition-opacity z-50"></div>`;
  }
