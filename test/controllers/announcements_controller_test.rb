...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference("Announcement.count") do
      post announcements_url, params: { announcement: { body_en: @announcement.body_en, body_fr: @announcement.body_fr, title_en: @announcement.title_en, title_fr: @announcement.title_fr } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { body_en: @announcement.body_en, body_fr: @announcement.body_fr, title_en: @announcement.title_en, title_fr: @announcement.title_fr } }
